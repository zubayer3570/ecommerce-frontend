...
const Footer = ({ position }) => {
    ...
    return (
        <footer
            className={`${positionStyle} w-full bg-3 text-[white] pt-12 pb-8 px-6 mt-[200px]`}
        >
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
                {/* Brand Section */}
                <div>
                    <h2 className="text-2xl font-bold text-white mb-4">Soundex</h2>
                    <p className="text-sm leading-relaxed text-gray-400">
                        Soundex is your trusted platform for high-quality sound
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-400">support@soundex.com</p>
            ...
            <div className="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
                <p className="text-sm text-gray-400">
                    © {new Date().getFullYear()} Soundex · Zubayer. All rights reserved.
                </p>

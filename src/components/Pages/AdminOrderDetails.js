        ...
        <div className='w-[70%] mx-auto' >
            ...
            <div className='grid grid-cols-2 mx-4'>
                ...
                <div className='ml-4'>
                    ...
                    <p className='mt-4'><span className='my-4 font-bold'>Quantity: </span>{orderDetails.quantity} piece</p>
                    ...
                    <p className='mb-4'><span className='my-4 font-bold'>Delivery Status: </span> {orderDetails.shippingStatus} </p>
